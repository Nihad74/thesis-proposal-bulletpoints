...
- *Vision*
  ...
  - Preserve the correctness and reproducability of historical submissions and statistics. 
...
- *Positive Framing*
  ...
  - *Instructors* benefit from consistent questions ediditing and trustworthy historical results. 
  ...
  - Quantitative evaluation provides evidence about when JSON-based peristence is beneficial in established relational applications. 